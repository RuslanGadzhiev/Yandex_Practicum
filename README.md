...
|06|[**Рекомендация тарифов**]()|Построение лучшей модели и поиск оптимальных параметров для задачи классификации, которая выберет подходящий тариф. |`pandas`, `scipy`, `sklearn`, `matplotlib`, `seaborn`,`IPython`,`dummy`,`joblib`|
